...
#ifndef APEX_OVERLAYWINDOW_H
#define APEX_OVERLAYWINDOW_H
...
namespace Drawings {
    ...
    public:
        ...
        void style() {
            ...
            io.Fonts->AddFontFromFileTTF("Assets/Roboto-Bold.ttf", 14);
        }
        ...
        void run(bool(*update)(), void(*renderImgui)()) {
            ...
            Features::Settings::getInstance().SetScreenSize(_screenWidth, _screenHeight);
            ...
            while(!glfwWindowShouldClose(_window)) {
                ...
                ImGui::SetWindowSize("Draw Overlay", ImVec2(static_cast<float>(_screenWidth), static_cast<float>(_screenHeight)));
                ImGui::SetWindowPos("Draw Overlay", ImVec2(0, 0));
                ImGui::Begin("Draw Overlay", nullptr, ImGuiWindowFlags_NoBackground | ImGuiWindowFlags_NoTitleBar | ImGuiWindowFlags_NoMove | ImGuiWindowFlags_NoResize);
                if(update != nullptr) {
                    if(!update()){
                        break;
                    }
